/*ROBOT CAR BLUETOOTH CONTROL 
OPTIONS:
1)CONTROLING CAR IN ALL DIRECTIONS
2)CONTROLING CAR SPEED
3)FRONT LIGHT LED
4)BACK LIGHT LED
5)WITING LIGHT
6)HORN USING BUZZER*/
...
//L298n Motor Driver (MOTORS CONTROLER) pins
#define in1 5 
#define in2 6
#define in3 7
#define in4 8
...
//Horn Buzzer pin
#define horn_Buzz 18          // pin A4 for Arduino Uno
...
case 'x':lightBack = false,lightFront = false ;break;
case 'X':lightBack = true,lightFront = true ;break;
...
//MOTIION COMMANDS USING APLICATION
void forward() {
